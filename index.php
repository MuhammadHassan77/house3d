<?php
require('func.php');
$modelId = $modelSize = $wallColor = $wallName = $interiorName = $interiorColor = $roofName = $roofColor  = '';
$parts = $det = '';
if (!empty($_GET['id'])) {
	$id = $_GET['id'];
	...
	$modelSize = $details->modelSize;
	$wallName = $details->wallColor->name;
	$wallColor = $details->wallColor->color;
	$interiorColor = $details->interiorColor->color;
	$interiorName = $details->interiorColor->name;
	$roofName = $details->roofColor->name;
	$roofColor = $details->roofColor->color;
	$parts = $details->partsToggle;
	// print_r($parts);
...
<body>
	...
	<nav class="navbar nav-style navbar-light m-0 p-0">
		...
		<div class="save_url_btns d-none">
			<button class="saveChanges theme-btn">Save Changes</button>
	...
	<div class="canvas-div">
		...
		<script>
			...
			clara.on('loaded', function() {
				...
				if ('<?= $modelId ?>' != "") {
					// console.log(config)
					models.map((model, i) => hideModel(model))
					<?= $modelId != "" ? "showModel('$modelId'); config.modelId='$modelId'; config.modelSize='$modelSize'; " : ""; ?>
					<?= (!empty($parts)) ? "config.partsToggle = " . json_encode($parts) . ";" : null; ?>
					<?= $wallColor != "" ? "setColor('$wallName','$wallColor'); config.wallColor.color='$wallColor'; " : ""; ?>
					<?= $interiorColor != "" ? "setColor('$interiorName','$interiorColor'); config.interiorColor.color='$interiorColor'; " : ""; ?>
					<?= $roofColor != "" ? "setColor('$roofName','$roofColor'); config.roofColor.color='$roofColor';" : ""; ?>
					<?= json_encode($parts) ?>.map((part, i) => {
						if (part.name == config.partsToggle[i].name) {
							part.visibility == true ? showModel(part.name) : hideModel(part.name);
							// console.log($(`.toggleParts:eq(${i})`).attr("data-partname"))
							// if (part.visibility == true)
							// 	console.log($(`.toggleParts[data-partname='${part.name}'] input`).prop('checked', false))
							// else
							// 	console.log($(`.toggleParts[data-partname='${part.name}'] input`).prop('checked', true))
						}
					})

				} else {
					$(".selectSize:first,.selectModel:first").trigger("click");
					setTimeout(() => $(".menu-btn").trigger("click"), 250);
				}
			});

			var model_id = 'e6fc8298-5043-4648-af57-8ebae02e7649';
			// var model_id = '0b4a364f-b124-41d1-8403-26a8adf2abfb';
	...
	<section>
		...
		<div class="cart-btn">
			...
			<button type="button" class="btn theme-btn ad-cart" data-bs-toggle="modal" data-bs-target="#staticBackdrop">ADD
				CART</button>
		</div>
	</section>
	...
	<div class="desktop-view">
			...
			<div class="first-menu ">
				<ul class="d-flex justify-content-center m-0 p-0 w-75 ">
					<li class="tabs-item selectModel" data-modelid="Model 1 S1">
						...
						<p>Model 1</p>
						<label class="box">
							<input type="radio" name="modelRadio">
			...
			<div class="size-menu ">
				<ul class="d-flex justify-content-center m-0 p-0  w-75 ">
					<li class="tabs-item selectSize">
						...
						<p>8'x'10</p>
						<label class="box">
							<input type="radio" checked name="sizeRadio">
							<span class="checkmark"></span>
						</label>
						<p class="m-0 p-0">$1122</p>
					</li>
		...
		<div class="story-tab third-tab">
			...
			<ul class="d-flex justify-content-center m-0 p-0  w-75">
				<li class="tabs-item  modelScale" data-scale="2" data-story="story1">
				...
				<li class="tabs-item  modelScale" data-scale="2.5" data-story="story2">
				...
				<li class="tabs-item  modelScale" data-scale="3" data-story="story3">
				...
				<li class="tabs-item  modelScale" data-scale="3.5" data-story="story4">
					<img src="img/m1.png" class="img-fluid">
					<p>8'x'10</p>
					<label class="box">
						<input type="radio" checked="checked" name="radio">
				...
				<li class="tabs-item  modelScale" data-scale="4" data-story="story5">
					<img src="img/m3.png" class="img-fluid">
					<p>8'x'10</p>
					<label class="box">
						<input type="radio" checked="checked" name="radio">
		...
		<div class="add-tab four-tab">
			...
			<ul class="d-flex justify-content-center m-0 p-0  w-75">
				<li class="tabs-item toggleParts" data-partName="M_Desk m1s1">
					<img src="img/a1.png" class="img-fluid">
					<p>8'x'10</p>
					<label class="box">
						<input type="radio" name="pNameradio">
						<span class="checkmark"></span>
					</label>
					<p class="m-0 p-0">Desk</p>
				</li>
				<li class="tabs-item toggleParts" data-partName="M_Estantes m1s1">
					...
					<p class="m-0 p-0">Chair</p>
				</li>
				<li class="tabs-item toggleParts" data-partName="M_Silla-Ejecutivo m1s1">
					...
					<p class="m-0 p-0">Shelve</p>
				</li>
				<li class="tabs-item toggleParts" data-partName="M_Sistema_mobiliario-Escritorio_pie-Rectangular m1s1">
					<img src="img/a1.png" class="img-fluid">
					<p>8'x'10</p>
					<label class="box">
						<input type="radio" name="pNameradio">
	...
	<div class="mob-view">
		...
		<!-- start-nav -->
		<footer class="top-fixed m-0 footer">
			<ul type="none" class="d-flex justify-content-center m-0 p-0">
				<li class="li-item mob-navigator" data-tab="#mobfirst-tab">
					<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500
						500" style="enable-background:new 0 0 500 500;" xml:space="preserve">
						<path d="M45,392.5c2.9-2.2,5.5-4.9,8.7-6.4c11.8-5.5,23.7-10.8,35.7-15.9c2.7-1.2,3.6-2.6,3.6-5.6c-0.1-56,0-112-0.2-168.1
								c0-6.1,2.2-9.5,7.8-11.9c45.7-19.5,91.3-39.2,137-58.8c3.1-1.3,4-3,3.9-6.2c-0.1-17.6-0.1-35.1-0.1-52.7c0-5.6,2.7-8.9,7.3-9.3
				...
				<li class="li-item mob-navigator" data-tab="#mobselectpart-tab">
					<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500" style="enable-background:new 0 0 500 500;" xml:space="preserve">
						<path d="M109.4,47.6c22.6,0,45.2,0.3,67.8-0.1c9.3-0.2,20.4,10.2,20.6,18.8c0.3,13.9,0.7,27.8,0.8,41.6c0.1,4.7-0.3,9.4-0.7,14.2
							c-0.5,6.9-4.1,12-9.7,15.9c-3.8,2.6-7.8,4-12.7,3.9c-40.9-0.2-81.8-0.2-122.8-0.3c-5.3,0-10.6-0.5-15.8-0.8
							c-4.2-0.3-7.6-2.3-10.3-5.4c-4.2-4.7-6.9-9.7-6.7-16.5c0.6-15.9,0.7-31.8,0.5-47.6c-0.1-10.9,4.4-18.5,14.5-22.6
				...
				<li class="li-item mob-navigator" data-tab="#mobtrd-tab">
					<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500" style="enable-background:new 0 0 500 500;" xml:space="preserve">
						<path d="M249.6,268.6c-8.9,0-17.3-2-25.2-6.1c-43.6-23-87.2-46-130.9-69c-5.3-2.8-8.4-7.2-8.3-13.2c0-5.9,3.1-10.1,8.3-12.8
							c43.5-22.8,86.8-45.6,130.4-68.3c16.9-8.8,34.3-8.9,51.1-0.1c43.7,22.8,87.3,45.9,130.9,68.9c5.2,2.7,8.1,7.1,8.1,13
							c0,5.9-2.9,10.2-8.1,12.9c-43.8,22.9-87.5,45.9-131.3,68.8C266.7,266.8,258.4,268.6,249.6,268.6z M249.7,248.6
				...
				<li class="li-item mob-navigator" data-tab="#mobfour-tab">
					<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500" style="enable-background:new 0 0 500 500;" xml:space="preserve">
						<path d="M183.5,274.3c1.7-23.5,11.9-35.7,29.6-35.9c9.4-0.1,17.2,3.5,23.4,10.6c4.9,5.6,5.8,9,7.4,25.3c4.9,0,9.8,0,14.8,0
						c4.8,0,9.7,0,14.9,0c0-9.2,0-18,0-26.8c0-3-0.1-6,0-9c0.2-3.8,2.4-6,6.2-6.1c4-0.1,8,0,12-0.1c10-0.2,17.8-8.2,17.8-18
						c0-9.8-7.8-17.7-17.8-17.9c-3.6-0.1-7.2,0-10.9,0c-5.1-0.1-7.2-2.2-7.2-7.4c0-13,0-26,0-38.9c0-5.6,2.1-7.6,7.7-7.6
				...
				<li class="li-item mob-navigator" data-tab="#mobfive-tab">
					<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500" style="enable-background:new 0 0 500 500;" xml:space="preserve">
						<path d="M254.5,264.9c1.4-1.5,3.1-3.5,4.9-5.3c10.7-10.8,21.4-21.5,32.2-32.2c7-6.9,17.5-4.4,20.1,4.7c1.2,4.3,0.1,8.1-3,11.1
							c-15.5,15.7-31.1,31.3-46.8,46.8c-5,4.9-11.7,4.7-16.7-0.3c-7.7-7.5-15.3-15.1-22.9-22.9c-4.9-5-4.9-12.1-0.2-16.8
							c4.6-4.6,11.7-4.6,16.8,0.3c4.9,4.7,9.6,9.5,14.4,14.2C253.4,264.8,253.6,264.8,254.5,264.9z" />
				...
				<li class="li-item mob-navigator d-none" data-tab="#mobsize-tab"></li>
				<li class="li-item mob-navigator d-none" data-tab="#mobsec-tab"></li>
			</ul>
		</footer>
		<!-- end-nav -->

		<!-- start-select-model-tab -->
		<div class="tabs-design d-none" id="mobfirst-tab">

			<div class="row p-0 m-0">
				<div class="col-12 p-0 m-0">
					<h2 class="title_heading">Select Model</h2>
			...
			<div class="row">
				<div class="col-6">
					<div class="model-box selectModel" data-modelid="Model 1 S1">
						<img src="img/h1.png" class="img-fluid">
						<p>lorem ipsum</p>
						<p>$1122</p>
					</div>
				...
				<div class="col-6">
					<div class="model-box selectModel" data-modelid="Model 2 S1">
						<img src="img/h2.png" class="img-fluid">
						<p>lorem ipsum</p>
						<p>$1122</p>
					</div>
				...
				<div class="col-6">
					<div class="model-box selectModel" data-modelid="Model 3 S1">
						<img src="img/h3.png" class="img-fluid">
						<p>lorem ipsum</p>
						<p>$1122</p>
					</div>
		...
		<!-- end-select-model-tab -->

		<!-- start-select-model-size -->
		<div class="tabs-design d-none" id="mobsize-tab">

			<div class="row p-0 m-0">
				<div class="col-12 p-0 m-0">
					<h2 class="title_heading">Select Size</h2>
					<span class="close-icon"><i class="fas fa-times"></i></span>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-6">
					<div class="model-box selectSize">
						<img src="img/s1.png" class="img-fluid">
						<p>lorem ipsum</p>
						<p>$1122</p>
					</div>
		...
		<!-- start-select-model-size -->
		<div class="tabs-design d-none" id="mobselectpart-tab">

			<div class="row p-0 m-0">
				<div class="col-12 p-0 m-0">
					<h2 class="title_heading">Select Part To Color</h2>
					<span class="close-icon"><i class="fas fa-times"></i></span>
				</div>
			</div>

			<div class="parts-select row">
				<div class="col-6">
					<div class="model-box" data-partName="Wood-SPI">
						<img src="img/h1.png" class="img-fluid">
						<p>lorem ipsum</p>
						<p>$1122</p>
					</div>
				...
				<div class="col-6">
					<div class="model-box" data-partName="Gypsum Wall Board">
						<img src="img/h2.png" class="img-fluid">
						<p>lorem ipsum</p>
						<p>$1122</p>
					</div>
				...
				<div class="col-6">
					<div class="model-box" data-partName="structure, Wood Joist/Rafter Layer, Batt Insulation">
						<img src="img/h3.png" class="img-fluid">
						<p>lorem ipsum</p>
						<p>$1122</p>
					</div>
		...
		<!-- start-color-tab -->
		<div class="tabs-design d-none" id="mobsec-tab">

			<div class="row p-0 m-0">
				<div class="col-12 p-0 m-0">
					<h2 class="title_heading">Select Color</h2>
					<span class="close-icon"><i class="fas fa-times"></i></span>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-12">
					<div class="color-box" data-color="199,21,133" style="background-color: mediumvioletred;"></div>
					<div class="color-box" data-color="173,216,230" style="background-color: lightblue;"></div>
					<div class="color-box" data-color="173,255,47" style="background-color: greenyellow;"></div>
					<div class="color-box" data-color="0,255,255" style="background-color: aqua;"></div>
					<div class="color-box" data-color="255,69,0" style="background-color: orangered;"></div>
					<div class="color-box" data-color="0,0,0" style="background-color: black;"></div>
					<div class="color-box" data-color="245,245,245" style="background-color: whitesmoke;"></div>
					<div class="color-box" data-color="192,192,192" style="background-color: silver;"></div>
					<div class="color-box" data-color="165,42,42" style="background-color: brown;"></div>
					<div class="color-box" data-color="128,128,128" style="background-color: grey;"></div>
					<div class="color-box" data-color="124,252,0" style="background-color: lawngreen;"></div>
					<div class="color-box" data-color="255,218,185" style="background-color: peachpuff;"></div>
					<div class="color-box" data-color="250,128,114" style="background-color: salmon;"></div>
					<div class="color-box" data-color="240,230,140" style="background-color: khaki;"></div>
				</div>
			</div>
		...
		<!-- start-stories-tab -->
		<div class="tabs-design d-none" id="mobtrd-tab">

			<div class="row p-0 m-0">
				<div class="col-12 p-0 m-0">
					<h2 class="title_heading">Select stories</h2>
					<span class="close-icon"><i class="fas fa-times"></i></span>
				</div>
			</div>

			<div class="row tab-story">
				<div class="col-6">
					<div class="model-box" data-story="story1">
						<img src="img/m1.png" class="img-fluid">
						<p>lorem ipsum</p>
						<p>$1122</p>
					</div>
				...
				<div class="col-6">
					<div class="model-box" data-story="story2">
						<img src="img/m2.png" class="img-fluid">
						<p>lorem ipsum</p>
						<p>$1122</p>
					</div>
				...
				<div class="col-6">
					<div class="model-box" data-story="story3">
						<img src="img/m3.png" class="img-fluid">
						<p>lorem ipsum</p>
						<p>$1122</p>
					</div>
				...
				<div class="col-6">
					<div class="model-box" data-story="story4">
						<img src="img/m1.png" class="img-fluid">
						<p>lorem ipsum</p>
						<p>$1122</p>
					</div>
				...
				<div class="col-6">
					<div class="model-box" data-story="story5">
						<img src="img/m3.png" class="img-fluid">
						<p>lorem ipsum</p>
						<p>$1122</p>
					</div>
		...
		<!-- start-addons-tab -->
		<div class="tabs-design d-none" id="mobfour-tab">

			<div class="row p-0 m-0">
				<div class="col-12 p-0 m-0">
					<h2 class="title_heading">Select addons</h2>
					<span class="close-icon"><i class="fas fa-times"></i></span>
				</div>
			</div>

			<div class="row partsRow">
				<div class="col-6">
					<div class="model-box toggleParts" data-partName="M_Desk m1s1">
						<img src="img/a1.png" class="img-fluid">
						<p>lorem ipsum</p>
						<p>$1122</p>
					</div>
				...
				<div class="col-6">
					<div class="model-box toggleParts" data-partName="M_Estantes m1s1">
						<img src="img/a2.png" class="img-fluid">
						<p>lorem ipsum</p>
						<p>$1122</p>
					</div>
				...
				<div class="col-6">
					<div class="model-box toggleParts" data-partName="M_Silla-Ejecutivo m1s1">
						<img src="img/a3.png" class="img-fluid">
						<p>lorem ipsum</p>
						<p>$1122</p>
					</div>
				...
				<div class="col-6">
					<div class="model-box toggleParts" data-partName="M_Sistema_mobiliario-Escritorio_pie-Rectangular m1s1">
						<img src="img/a1.png" class="img-fluid">
						<p>lorem ipsum</p>
						<p>$1122</p>
					</div>
		...
		<!-- start-installation-tab -->
		<div class="tabs-design d-none" id="mobfive-tab">

			<div class="row p-0 m-0">
				<div class="col-12 p-0 m-0">
					<h2 class="title_heading">Select installation</h2>
					<span class="close-icon"><i class="fas fa-times"></i></span>
				</div>
			</div>
				...
				<div class="form-div justify-content-center  mx-auto">
					...
					<div class="signup">
						<form>
							...
							<label class="showError signupMsg m-0 p-0"></label>
					...
					<div class="login">
						<form>
							...
							<label class="showError loginMsg m-0 p-0"></label>
	...
	<!--start enquiry model  -->
	<div class="modal fade" id="enquiryModel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="saveUrl">Save Url</label>
						<input type="text" class="form-control" id="saveUrl" name="" readonly />
					</div>
					<div class="form-group">
						<label for="">Stories</label>
						<input type="text" class="form-control" id="story" name="" readonly />
					</div>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-outline-primary mybtn2" id="enq_btn">Save changes</button>
				</div>
			</div>
		</div>
	</div>
	...
	<!-- saveUrl pupap -->
	<div class="modal fade" id="urlPupop" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Modal title</h5>
				...
				<div class="modal-body">
					<input type="text" id="urlShow" class="form-control" readonly>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
					<button type="button" id="applyChangesBtn" class="btn btn-primary">Save changes</button>
				</div>
			</div>
		</div>
	</div>

	<input type="hidden" id="currentUser" value="<?= isset($_SESSION['user']) ? $_SESSION['user'] : '' ?>">
	...
	<script>
		...
		let partNames = [{
				...
				"Chair": {
					name: "M_Silla-Ejecutivo m1s1",
					visibility: true,
				},
				"Shelve": {
					name: "M_Estantes m1s1",
					visibility: true,
				},
				"Side Table": {
					name: "M_Sistema_mobiliario-Escritorio_pie-Rectangular m1s1",
					visibility: true,
				}
			},
			{
				...
				"Chair": {
					name: "M_Silla-Ejecutivo m1s2",
					visibility: true,
				},
				"Shelve": {
					name: "M_Estantes m1s2",
					visibility: true,
				},
				"Gruop Of Chairs": {
					name: "Chair-Breuer m1s2",
					visibility: true,
				},
				"Table": {
					name: "Counter Top-Island m1s2",
					visibility: true,
				}
			},
			{
				...
				"Chair": {
					name: "M_Silla-Ejecutivo m1s3",
					visibility: true,
				},
				"Shelve": {
					name: "M_Estantes m1s3",
					visibility: true,
				},
				"Wall Embeded Table": {
					name: ["M_Sistema_mobiliario-Superficie_trabajo-Rectangular-con_Soporte  m1s3", "M_Sistema_mobiliario-Hardware-Soporte m1s3"],
					visibility: true,
				},
				"Gruop Of Chairs": {
					name: "M_Silla-Oficina (brazos) m1s3",
					visibility: true,
				},
				"Stove": {
					name: ["Kitchenette - Small m1s3", "Counter Top w Sink Hole m1s3", "Sink Kitchen-Island m1s3", "Cook Top-2 Unit m1s3"],
					visibility: true,
				}
			},
			{
				...
				"Bed": {
					name: "M_Cama-Estndar m2s1",
					visibility: true,
				},
				"Wall Embeded Table": {
					name: ["M_Sistema_mobiliario-Superficie_trabajo-Rectangular-con_Soporte m2s1", "M_Sistema_mobiliario-Hardware-Soporte m2s1"],
					visibility: true,
				},
				"Chair": {
					name: "M_Silla-Ejecutivo m2s1",
					visibility: true,
				},
				// "Bath Tub": {name:"M_Baera-Rectangular-3D m2s1",visibility: true,},
				// "Flush": {name:"M_Retrete-Dom?stico-3D m2s1",visibility: true,},
				// "Sink": {name:"M_Fregadero armario-Redondo m2s1",visibility: true,},
				"Sofa": {
					name: "M_Sofa-Corbu m2s1",
					visibility: true,
				},
				"Round Table": {
					name: "M_Mesa-Comedor redonda con sillas m2s1",
					visibility: true,
				},
				"Gruop Of Chairs": {
					name: "M_Silla-Breuer m2s1",
					visibility: true,
				},
				"Stove": {
					name: ["M_Cocinita - Media m2s1", "M_Lavavajillas m2s1", "M_Encimera con agujero para fregadero m2s1", "M_Fregadero de cocina-Isla m2s1", "M_Cocina encimera-4 fuegos2 m2s1"],
					visibility: true,
				},
				"Refrigerator": {
					name: "M_Refrigerador m2s1",
					visibility: true,
				},
				"Iron Stand": {
					name: "M_Sistema_mobiliario-Superficie_trabajo-Extremo_redondo m2s1",
					visibility: true,
				},
				"Folding Door": {
					name: "Bifold-2 Panel m2s1",
					visibility: true,
				},
			},
			{
				...
				"Chair": {
					name: "M_Silla-Ejecutivo m3s1",
					visibility: true,
				},
				"Shelve": {
					name: "M_Estantes m3s1",
					visibility: true,
				},
				"Sofa": {
					name: "M_Sofa m3s1",
			...
			},
			{
				...
				"Round Table": {
					name: "M_Mesa-Comedor redonda con sillas m3s2",
					visibility: true,
				},
				"Stove": {
					name: ["M_Cocinita - Pequea m3s2", "M_Encimera con agujero para fregadero m3s2", "M_Fregadero de cocina-Isla m3s2", "M_Cocina encimera-2 fuegos m3s2"],
					visibility: true,
				},
				"Group Of Chair": {
					name: "M_Silla-Breuer m3s2",
					visibility: true,
				},
				"Side Table": {
					name: "M_Mesa-Extremo m3s2",
					visibility: true,
				},
				"Outer Part": {
					name: "M_Madera de construccin m3s2",
					visibility: true,
				},
				"Table": {
					name: "M_Mesa-Rectangular m3s2",
					visibility: true,
				},
			},
			{
				...
				"Table": {
					name: "M_Mesa-Rectangular m3s3",
					visibility: true,
				},
				"Round Table": {
					name: "M_Mesa-Comedor redonda con sillas m3s3",
					visibility: true,
				},
				"Shelve": {
					name: "M_Estantes m3s3",
					visibility: true,
				},
				"Stove": {
					name: ["M_Cocinita - Media m3s3", "M_Lavavajillas m3s3", "M_Encimera con agujero para fregadero m3s3", "M_Fregadero de cocina-Isla m3s3", "M_Cocina encimera-4 fuegos2 m3s3"],
					visibility: true,
				},
				"Group Of Chair": {
					name: "M_Silla-Breuer m3s3",
					visibility: true,
				},
				"Refrigerator": {
					name: "M_Refrigerador m3s3",
					visibility: true,
				},
				"Inner Folding Door": {
					name: "Bifold-2 Panel m3s3",
					visibility: true,
				},
				"Side Table": {
					name: "M_Mesa-Extremo m3s3",
					visibility: true,
				},
				"Outter Part": {
					name: "M_Madera de construccin m3s3",
					visibility: true,
				},
			}
		];
